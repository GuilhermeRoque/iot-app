const ttn_frequency_plans = [
    ...
    },
    {
      ...
      "description": "Frequency plan for Japanese land mobile station, using continuous frequencies up to 923.4MHz with MAX EIRP 27 dBm and LBT.\n(note) A user who installs land mobile station in Japan must apply to Japanese Ministry of Internal Affairs and Communications.\n",
      "base-frequency": 915,
    ...
    },
    {
      ...
      "description": "Frequency plan for Japanese land mobile station (16 channels), using continuous frequencies from 920.6 MHz with MAX EIRP 27 dBm and LBT, expected to be used with AS_920_923_TTN_JP_1.\n(note) A user who installs land mobile station in Japan must apply to Japanese Ministry of Internal Affairs and Communications.\n",
      "base-frequency": 915,
